...
| ------------------- | ---------------------------------------- | ---------------------------------------------------- | ----------------------------------------------------- |
| Required - commands | Command parser entry point (all 6 verbs) | `src/lib/architecture-commands.ts:629-935`           | [view](docs/categories/command-parser-entry-point.md) |
| Required - commands | `add node`                               | `src/lib/architecture-commands.ts:587-592,648-679`   | [view](docs/categories/add-node.md)                   |
| Required - commands | `connect` (add edge)                     | `src/lib/architecture-commands.ts:680-752`           | [view](docs/categories/connect-add-edge.md)           |
| Required - commands | `remove node` (cascading delete)         | `src/lib/architecture-commands.ts:753-774`           | [view](docs/categories/remove-node.md)                |
| Required - commands | `remove edge`                            | `src/lib/architecture-commands.ts:775-813`           | [view](docs/categories/remove-edge.md)                |
| Required - commands | `rename node`                            | `src/lib/architecture-commands.ts:814-870`           | [view](docs/categories/rename-node.md)                |
| Required - commands | `move node ... to step ...`              | `src/lib/architecture-commands.ts:871-932`           | [view](docs/categories/move-node-to-step.md)          |
| Required - commands | Suffix-trie substring index              | `src/lib/architecture-commands.ts:124-290`           | [view](docs/categories/suffix-trie-index.md)          |
...
| Required - commands | Unrecognized / ambiguous command errors  | `src/lib/architecture-commands.ts:292-313,933-935`   | [view](docs/categories/command-errors.md)             |
| Required - commands | Sole `parseCommand` call site            | `src/components/architecture-workspace.tsx:421-495`  | [view](docs/categories/parsecommand-call-site.md)     |
...
| Bonus - extras      | Merge picker dialog                      | `src/components/merge-picker-dialog.tsx:1-542`       | [view](docs/categories/merge-picker-dialog.md)        |
